...
`ccd` is a Python client for accessing the Covid County Data database

Links:

- [Repository](https://github.com/CovidCountyData/ccd.py)
...
- Build tools, such as this library and the [Julia](https://github.com/CovidCountyData/CCD.jl) and [R](https://github.com/CovidCountyData/ccdR), to simplify the data ingestion process
...
This package is available on the [Python Package Index (pypi)](https://pypi.org/project/ccd/) and can be installed by
...
If at any time you would like to remove your API key, please delete the file `~/.ccd/apikey`
...
There are more examples in the `ccd/examples.py` file. We encourage you to explore them and to reach out if you have questions!
